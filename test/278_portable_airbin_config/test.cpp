...
int addone_driver(aie_libxaie_ctx_t *xaie, int fd, queue_t *q, int col, int row) {
  /////////////////////////////////////////////////////////////////////////////
  ...
  air_packet_nd_memcpy(pkt1, 0, col, 1, 0, 4, 2, (uint64_t)bb_paddr, DMA_COUNT*sizeof(float), 1, 0, 1, 0, 1, 0);
  ...
  air_packet_nd_memcpy(pkt2, 0, col, 0, 0, 4, 2, (uint64_t)bb_paddr+(DMA_COUNT*sizeof(float)), DMA_COUNT*sizeof(float), 1, 0, 1, 0, 1, 0);
