...
#define TD_ADDR 0x810000
#define DATA_ADDR 0x811000
//#define TD_ADDR   0x20100006000
//#define DATA_ADDR 0x20100007000
...
//int32_t mlir_aie_read_buffer_ping_in(aie_libxaie_ctx_t* ctx, int col, int row, int index) {
//  int32_t value = XAieTile_DmReadWord(&(ctx->TileInst[col][row]), ping_in_ofst + (index*4));
//  return value;
//}
//void mlir_aie_write_buffer_ping_in(aie_libxaie_ctx_t* ctx, int col, int row, int index, int32_t value) {
//  int32_t int_value = value;
//  return XAieTile_DmWriteWord(&(ctx->TileInst[col][row]), ping_in_ofst + (index*4), int_value);
//}
//const int ping_out_ofst = 4128;
//int32_t mlir_aie_read_buffer_ping_out(aie_libxaie_ctx_t* ctx, int col, int row, int index) {
//  int32_t value = XAieTile_DmReadWord(&(ctx->TileInst[col][row]), ping_out_ofst + (index*4));
//  return value;
//}
//void mlir_aie_write_buffer_ping_out(aie_libxaie_ctx_t* ctx, int col, int row, int index, int32_t value) {
//  int32_t int_value = value;
//  return XAieTile_DmWriteWord(&(ctx->TileInst[col][row]), ping_out_ofst + (index*4), int_value);
//}
//const int pong_in_ofst = 4160;
//int32_t mlir_aie_read_buffer_pong_in(aie_libxaie_ctx_t* ctx, int col, int row, int index) {
//  int32_t value = XAieTile_DmReadWord(&(ctx->TileInst[col][row]), pong_in_ofst + (index*4));
//  return value;
//}
//void mlir_aie_write_buffer_pong_in(aie_libxaie_ctx_t* ctx, int col, int row, int index, int32_t value) {
//  int32_t int_value = value;
//  return XAieTile_DmWriteWord(&(ctx->TileInst[col][row]), pong_in_ofst + (index*4), int_value);
//}
//const int pong_out_ofst = 4192;
//int32_t mlir_aie_read_buffer_pong_out(aie_libxaie_ctx_t* ctx, int col, int row, int index) {
//  int32_t value = XAieTile_DmReadWord(&(ctx->TileInst[col][row]), pong_out_ofst + (index*4));
//  return value;
//}
//void mlir_aie_write_buffer_pong_out(aie_libxaie_ctx_t* ctx, int col, int row, int index, int32_t value) {
//  int32_t int_value = value;
//  return XAieTile_DmWriteWord(&(ctx->TileInst[col][row]), pong_out_ofst + (index*4), int_value);
//}
//const int ping_a_offset = 4096;
//int32_t mlir_aie_read_buffer_ping_a(aie_libxaie_ctx_t* ctx, int col, int row, int index) {
//  int32_t value = XAieTile_DmReadWord(&(ctx->TileInst[col][row]), ping_a_offset + (index*4));
//  return value;
//}
//void mlir_aie_write_buffer_ping_a(aie_libxaie_ctx_t* ctx, int col, int row, int index, int32_t value) {
//  int32_t int_value = value;
//  return XAieTile_DmWriteWord(&(ctx->TileInst[col][row]), ping_a_offset + (index*4), int_value);
//}
//const int ping_b_offset = 8192;
//int32_t mlir_aie_read_buffer_ping_b(aie_libxaie_ctx_t* ctx, int col, int row, int index) {
//  int32_t value = XAieTile_DmReadWord(&(ctx->TileInst[col][row]), ping_b_offset + (index*4));
//  return value;
//}
//void mlir_aie_write_buffer_ping_b(aie_libxaie_ctx_t* ctx, int col, int row, int index, int32_t value) {
//  int32_t int_value = value;
//  return XAieTile_DmWriteWord(&(ctx->TileInst[col][row]), ping_b_offset + (index*4), int_value);
//}
//const int ping_c_offset = 12288;
//int32_t mlir_aie_read_buffer_ping_c(aie_libxaie_ctx_t* ctx, int col, int row, int index) {
//  int32_t value = XAieTile_DmReadWord(&(ctx->TileInst[col][row]), ping_c_offset + (index*4));
//  return value;
//}
//void mlir_aie_write_buffer_ping_c(aie_libxaie_ctx_t* ctx, int col, int row, int index, int32_t value) {
//  int32_t int_value = value;
//  return XAieTile_DmWriteWord(&(ctx->TileInst[col][row]), ping_c_offset + (index*4), int_value);
//}
//const int pong_a_offset = 16384;
//int32_t mlir_aie_read_buffer_pong_a(aie_libxaie_ctx_t* ctx, int col, int row, int index) {
//  int32_t value = XAieTile_DmReadWord(&(ctx->TileInst[col][row]), pong_a_offset + (index*4));
//  return value;
//}
//void mlir_aie_write_buffer_pong_a(aie_libxaie_ctx_t* ctx, int col, int row, int index, int32_t value) {
//  int32_t int_value = value;
//  return XAieTile_DmWriteWord(&(ctx->TileInst[col][row]), pong_a_offset + (index*4), int_value);
//}
//const int pong_b_offset = 20480;
//int32_t mlir_aie_read_buffer_pong_b(aie_libxaie_ctx_t* ctx, int col, int row, int index) {
//  int32_t value = XAieTile_DmReadWord(&(ctx->TileInst[col][row]), pong_b_offset + (index*4));
//  return value;
//}
//void mlir_aie_write_buffer_pong_b(aie_libxaie_ctx_t* ctx, int col, int row, int index, int32_t value) {
//  int32_t int_value = value;
//  return XAieTile_DmWriteWord(&(ctx->TileInst[col][row]), pong_b_offset + (index*4), int_value);
//}
//const int pong_c_offset = 24576;
//int32_t mlir_aie_read_buffer_pong_c(aie_libxaie_ctx_t* ctx, int col, int row, int index) {
//  int32_t value = XAieTile_DmReadWord(&(ctx->TileInst[col][row]), pong_c_offset + (index*4));
//  return value;
//}
//void mlir_aie_write_buffer_pong_c(aie_libxaie_ctx_t* ctx, int col, int row, int index, int32_t value) {
//  int32_t int_value = value;
//  return XAieTile_DmWriteWord(&(ctx->TileInst[col][row]), pong_c_offset + (index*4), int_value);
//}
...
int addone_driver(queue_t *q, int col, int row) {
  ...
  //XAieLib_MemInst *mem2 = XAieLib_MemAllocate(2*DMA_COUNT*sizeof(uint32_t), 0);
  ...
  //volatile uint32_t *bb_paddr = (uint32_t *)(0x00000600000);
  //volatile uint32_t *bb_paddr = (uint32_t *)(0x20100008000);
  volatile uint32_t *paddr = (uint32_t *)(0x800000);
  ...
  air_packet_cdma_memcpy(pkt, 0, 0, 0xffffffff);
  pkt->type = 0x5;
  pkt->arg[0]  = col;
  pkt->arg[1]  = row;
  wr_idx = queue_add_write_index(q, 1);
  ...
  //packet_id = wr_idx % q->size;
  //pkt = (dispatch_packet_t*)(q->base_address_vaddr) + packet_id;
  //air_packet_cdma_memcpy(pkt, (uint64_t)paddr, (uint64_t)bb_paddr, DMA_COUNT*2*sizeof(float));
  //air_queue_dispatch_and_wait(q, wr_idx, pkt); 
  ...
  air_packet_nd_memcpy(pkt1, 0, col, 1, 0, 4, 2, (uint64_t)paddr, DMA_COUNT*sizeof(float), 1, 0, 1, 0, 1, 0);
  ...
  air_packet_nd_memcpy(pkt2, 0, col, 0, 0, 4, 2, (uint64_t)paddr+(DMA_COUNT*sizeof(float)), DMA_COUNT*sizeof(float), 1, 0, 1, 0, 1, 0);
  air_queue_dispatch_and_wait(q, wr_idx, pkt2);

  //wr_idx = queue_add_write_index(q, 1);
  //packet_id = wr_idx % q->size;
  //pkt = (dispatch_packet_t*)(q->base_address_vaddr) + packet_id;
  //air_packet_cdma_memcpy(pkt, (uint64_t)bb_paddr, (uint64_t)paddr, DMA_COUNT*2*sizeof(float));
  //air_queue_dispatch_and_wait(q, wr_idx, pkt); 
...
//int matadd_driver(aie_libxaie_ctx_t *xaie, int fd, queue_t *q, int col, int row) {
//  // test configuration
...
//
//  XAieLib_MemInst *mem2 = XAieLib_MemAllocate(3*IMAGE_SIZE*sizeof(uint32_t), 0);
...
//  air_packet_nd_memcpy(pkt_c, 0, col, 0, 0, 4, 2, uint64_t(dram_paddr)+(2*IMAGE_SIZE*sizeof(float)), TILE_WIDTH*sizeof(float), TILE_HEIGHT, IMAGE_WIDTH*sizeof(float), NUM_3D, TILE_WIDTH*sizeof(float), NUM_4D, IMAGE_WIDTH*TILE_HEIGHT*sizeof(float));
//
//  //
...
//  air_packet_nd_memcpy(pkt_a, 0, col, 1, 0, 4, 2, uint64_t(dram_paddr), TILE_WIDTH*sizeof(float), TILE_HEIGHT, IMAGE_WIDTH*sizeof(float), NUM_3D, TILE_WIDTH*sizeof(float), NUM_4D, IMAGE_WIDTH*TILE_HEIGHT*sizeof(float));
//
//  wr_idx = queue_add_write_index(q, 1);
//  packet_id = wr_idx % q->size;
//  dispatch_packet_t *pkt_b = (dispatch_packet_t*)(q->base_address_vaddr) + packet_id;
//  air_packet_nd_memcpy(pkt_b, 0, col, 1, 1, 4, 2, uint64_t(dram_paddr)+(IMAGE_SIZE*sizeof(float)), TILE_WIDTH*sizeof(float), TILE_HEIGHT, IMAGE_WIDTH*sizeof(float), NUM_3D, TILE_WIDTH*sizeof(float), NUM_4D, IMAGE_WIDTH*TILE_HEIGHT*sizeof(float));
//
//  //
...
int main(int argc, char **argv) {
  ...
  uint64_t *virt_addr = (uint64_t *)(map_axib_base);
  printf("virtual address = 0x%lx\n", (unsigned long) virt_addr);

  //XAieLib_MemInst *mem = XAieLib_MemAllocate(2*65536, XAIELIB_MEM_ATTR_CACHE);
  volatile uint32_t *bram_ptr = (volatile uint32_t *)(virt_addr+0x1000); // Config data ptr
  ...
  //volatile uint32_t *shim_addr = (volatile uint32_t *)(map_aie_base+getTileAddr_BAR(start_col,0)+0x36048);
  //*shim_addr = 1;
  //*shim_addr = 0;

  //for (int r=start_row+1; r<num_rows; r++) {
  //  volatile uint32_t *tile_ctrl_addr = (volatile uint32_t *)(map_aie_base+getTileAddr_BAR(start_col,r)+0x32000);
  //  printf("Core %d,%d status reg: %x\n",start_col,r,tile_ctrl_addr[1]);
  //  *tile_ctrl_addr = 0x2; 
  //  printf("Core %d,%d status reg: %x\n",start_col,r,tile_ctrl_addr[1]);
  //} 
  ...
  ////for (int r=start_row+1; r<num_rows; r++) {
  ////  for (int l=0; l<16; l++) {
  ////    volatile uint32_t *tile_lock_addr = (volatile uint32_t *)(map_aie_base+getTileAddr_BAR(start_col,r)+0x1E020+0x80*l);
  ////    uint32_t Count = 10;
  ////    while (Count > 0U) {
  ...
  std::cout << "Compute tile " << std::dec << col << "," << 2 <<  " = " << std::hex << getTileAddr(col,2) << std::endl << std::endl;

  int errors = 0; 

  if (strcmp(airbin_name, "addone.airbin") == 0) {
    errors = addone_driver(q,col,num_rows-1);
